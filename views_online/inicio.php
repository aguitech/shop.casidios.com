			...
			<div style="width:100%; height:100%;">
				<div style="" class="contenedor_principal">
					<div class="header">
						...
						<a class="menu_header bg_gold smooth" style="width:50px; color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px; margin-left:0px; margin-top:5px; cursor:pointer;" onclick="$('#add_direction').hide(); $('#sitio_web').hide(); $('#sign_up').hide(); $('#log_in').show(); load_log_in();">
							
							<i class="material-icons right goldtext" title="Iniciar sesi&oacute;n" alt="Iniciar sesi&oacute;n">login</i>
							
						</a>
						<a class="menu_header smooth" style="width:50px; color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px; margin-left:0; margin-right:0; margin-top:5px; cursor:pointer;" onclick="$('#add_direction').hide(); $('#sitio_web').hide(); $('#log_in').hide(); $('#sign_up').show(); load_sign_up()">
							
							<i class="material-icons right goldtext" title="Reg&iacute;strate" alt="Reg&iacute;strate">person</i>
							
						</a>
						<?php else: ?>
						<a class="menu_header bg_gold smooth" style="width:50px; color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px;  margin-left:0; margin-left:0; margin-right:0; margin-top:5px; cursor:pointer;" href="/views_online/php/logout.php?next=<?php echo urlencode($_SERVER["SCRIPT_URI"]); ?>">
						...
						<a class="menu_header smooth" style="/*Color turquesa color:#99D3E4;*/color:#22568f; padding:10px 0px; font-size:13px; border-radius:5px; height:40px; margin-left:0; margin-right:0; margin-top:5px; cursor:pointer;" onclick="">
							<?php echo $_SESSION["registroname"]; ?>
						</a>
						<?php endif; ?>
						
						<a class="menu_header smooth" style="width:50px; color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px; margin-left:0; margin-right:0; margin-top:5px; cursor:pointer;" onclick="$('#add_direction').hide(); $('#sign_up').hide(); $('#log_in').hide(); $('#sitio_web').show();">
