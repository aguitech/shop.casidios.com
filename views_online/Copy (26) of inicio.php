...
$valor_usuario = $obj->get_row("select * from usuario left join sucursal on sucursal.id_sucursal = usuario.id_usuario where usuario.usuario like '{$exploded_url[0]}' and sucursal like '{$exploded_url[1]}'");
