...
<!--		<script src="js/jquery-1.7.2.js"></script>-->
	...
	<body onload="">
		...
		*/ ?>
		...
		<div style="display:none;" id="modal_bg" onclick="$('#modal_bg').slideUp('slow'); $('#modal_content').hide('slow'); location.reload();">
			
		</div>
		<div style="display:none;" id="modal_content" onclick="$('#modal_bg').slideUp('slow'); $('#modal_content').hide('slow'); location.reload();">
			<div style="height:100%; width:100%; display:flex; justify-content:center; align-items:center;">
    			<div style="width:200px; height:200px; border-radius:100%; margin:auto; background:white; display:flex; align-items:center;">
        			<div style="font-family:verdana; text-align:center; font-size:22px;" class="modal_msg">Tu pedido ha sido ordenado</div>
    			</div>
			</div>
		</div>
			...
			<div style="width:100%; height:100%;">
				<div style="" class="contenedor_principal">
					<div class="header">
						...
						<a class="menu_header bg_gold smooth" style="color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px;" onclick="$('#sitio_web').hide(); $('#sign_up').hide(); $('#log_in').show(); load_log_in();">
							Iniciar sesi&oacute;n
						</a>
						<a class="menu_header smooth" style="color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px;" onclick="$('#sitio_web').hide(); $('#log_in').hide(); $('#sign_up').show(); load_sign_up()">
							Reg&iacute;strate
						</a>
						
						<a class="menu_header smooth" style="color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px;" onclick="$('#sign_up').hide(); $('#log_in').hide(); $('#sitio_web').show();">
