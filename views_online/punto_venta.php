...
<!-- 
		...
		<link type="text/css" rel="stylesheet" href="https://aguitech.com/materialize/css/materialize.min.css"  media="screen,projection"/>
...
<style>
	...
	<body onload="<?php if($_GET["func"] == "new"): echo "cargar_crear()"; endif; ?>">
	   ...
	   <div style="position:absolute; top:0; left:0; right:0; bottom:0;">
		...
		<script type="text/javascript" src="https://aguitech.com/materialize/js/materialize.min.js"></script>
		<script>
