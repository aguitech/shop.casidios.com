	...
	*/
	...
	class db extends ezSQLcore
	{
		...
		*/
		...
		function __construct($dbuser=DB_USER, $dbpassword=DB_PASSWORD, $dbname=DB_NAME, $dbhost=DB_HOST, $encoding='utf8')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function quick_connect($dbuser=DB_USER, $dbpassword=DB_PASSWORD, $dbname=DB_NAME, $dbhost=DB_HOST, $dbport='3306', $encoding='utf8')
		{
			$return_val = false;
		...
		*/
		...
		{
			//file_put_contents("/var/www/html/santander2_0/log.txt", $query . PHP_EOL, FILE_APPEND);
