			...
			<div style="width:100%; height:100%;">
				<div style="" class="contenedor_principal">
					<div class="header">
						...
						<a class="menu_header smooth" style="color:#99D3E4; padding:10px; font-size:13px; border-radius:5px; height:40px;" onclick="$('#add_direction').hide(); $('#sign_up').hide(); $('#log_in').hide(); $('#sitio_web').show();">
