...
//$proyectofoto->get_query = "select * from proyectofoto where id_proyecto = $id";
//$proyectofoto->get_query = "select * from proyectofoto where id_proyecto = $id order by id_proyecto desc";
