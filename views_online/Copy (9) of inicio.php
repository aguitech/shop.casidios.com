					...
					//setTimeout("desanimar_clientes()", "500");
						...
						$.ajax({
	    					...
	    					success:function(data){
	    						...
	    						var data_href = "http://online.casidios.com/" + val_categoria + "/" + val_page; 
				...
				<div style="" class="contenedor_principal">
					<div class="header">
						<div class="logo" style="">
							<img src="http://aguitech.com/blue/images/logo_aguitech/Aguitech_logo.png" style="padding:0 0 0 0; height:50px;" id="imagen_logo" />
						</div>
						<!--
						...
						<div class="menu_mobile" onclick="$('#menu_mobile').show();">
							<img src="http://aguitech.com/blue/images/menu.png" style="width:20px;" />
						</div>
						<div style="clear:both;"></div>
					</div>
...
<!--							<img src="blue/images/imagenes_stock/Apple_Keyboard.png" class="imagen_seccion" />-->
							...
							*/
							...
							$.ajax({
								...
								success:function(data){
									...
									//var data_href = "http://aguitech.com"
									var data_href = "http://online.casidios.com/" + id + "/"; 
									$(".fb-comments").attr('data-href', data_href);
								    FB.XFBML.parse();
								}
							});
        ...
        */ ?>
        <div class="fb-comments" data-href="http://online.casidios.com/<?php echo $usuario_value->usuario; ?>" data-numposts="5"></div>
        <!-- 
		...
		-->
							...
							<div id="contenedor_blog" style="padding-top:55px;">
								...
								<div id="loader" style="display:none; text-align:center; margin-top:33px;">
									<img src="http://aguitech.com/blue/images/spinner.gif" style="width:77px;" />
								</div>
							</div>
