...
<button <?php if($_SESSION["idregistro"] != ""): ?>disabled="disabled"<?php endif; ?> class="btn waves-effect waves-light bg_aguitech" type="button" name="action" onclick="guardar_venta()"><?php if(isset($resultado->id_venta) && $resultado->id_venta != ""): ?>ACTUALIZAR<?php else: ?>HACER PEDIDO<?php endif; ?><!-- <i class="material-icons right">send</i> --></button>
