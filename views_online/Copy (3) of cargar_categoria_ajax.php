...
$categoria = $obj->get_row("select * from categoria where id_categoria = $id");
...
//$qry_blogs = "select * from blog left join categoria on blog.id_categoria = categoria.id_categoria where blog.mostrar = 1 and blog.id_categoria = $id order by blog.id_blog desc limit 5 offset 0";
$qry_blogs = "select * from blog left join categoria on blog.id_categoria = categoria.id_categoria where blog.mostrar = 1 and blog.id_categoria = $id order by blog.id_blog desc limit 1 offset 0";
//$blogs = $blog->get();
$blogs = $obj->get_results($qry_blogs);
...
<div style="text-align:center;">
	...
	*/ ?>
	<div class="fb-comments" data-href="http://online.casidios.com/<?php echo $usuario_value->usuario; ?>" data-numposts="1"></div>
